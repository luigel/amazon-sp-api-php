...
class Region implements ModelInterface, ArrayAccess
{
     ...
     * Sets country_code
     *
     * @param string $country_code ISO 3166 standard alpha-2 country code.
     *
     * @return $this
     */
     ...
     * Sets warehouse_id
     *
     * @param string $warehouse_id An identifier for a warehouse, such as a FC, IXD, upstream storage.
     *
     * @return $this
     */
