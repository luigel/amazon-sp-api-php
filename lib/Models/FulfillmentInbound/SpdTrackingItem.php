...
class SpdTrackingItem implements ModelInterface, ArrayAccess
{
     ...
     * Sets tracking_id
     *
     * @param string $tracking_id The tracking ID associated with each box in a non-Amazon partnered Small Parcel Delivery (SPD) shipment.
     *
     * @return $this
     */
     ...
     *
     * @param string $tracking_number_validation_status Whether or not Amazon has validated the tracking number. If more than 24 hours have passed and the status is not yet 'VALIDATED', please verify the number and update if necessary. Can be: `VALIDATED`, `NOT_VALIDATED`.
     *
     * @return $this
     */
