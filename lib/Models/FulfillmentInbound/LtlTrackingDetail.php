...
class LtlTrackingDetail implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $bill_of_lading_number The number of the carrier shipment acknowledgement document.
     *
     * @return $this
     */
     ...
     *
     * @param string[] $freight_bill_number The number associated with the freight bill.
     *
     * @return $this
     */
