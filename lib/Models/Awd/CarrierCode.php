...
class CarrierCode implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['carrier_code_type'] = isset($data['carrier_code_type']) ? $data['carrier_code_type'] : null;
        $this->container['carrier_code_value'] = isset($data['carrier_code_value']) ? $data['carrier_code_value'] : null;
    }
     ...
     *
     * @param string $carrier_code_value Value of the carrier code.
     *
     * @return $this
     */
