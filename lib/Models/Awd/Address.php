...
class Address implements ModelInterface, ArrayAccess
{
     ...
     * Sets address_line2
     *
     * @param string $address_line2 Optional second line of the address text.
     *
     * @return $this
     */
     ...
     * Sets address_line3
     *
     * @param string $address_line3 Optional third line of the address text.
     *
     * @return $this
     */
     ...
     * Sets phone_number
     *
     * @param string $phone_number Optional E.164-formatted phone number for an available contact at this address.
     *
     * @return $this
     */
     ...
     * Sets postal_code
     *
     * @param string $postal_code Optional postal code where this address is located.
     *
     * @return $this
     */
