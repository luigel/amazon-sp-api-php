...
class InventoryDetails implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['available_distributable_quantity'] = isset($data['available_distributable_quantity']) ? $data['available_distributable_quantity'] : null;
        $this->container['reserved_distributable_quantity'] = isset($data['reserved_distributable_quantity']) ? $data['reserved_distributable_quantity'] : null;
    }
     ...
     *
     * @param int $available_distributable_quantity Quantity that is available for downstream channel replenishment.
     *
     * @return $this
     */
     ...
     *
     * @param int $reserved_distributable_quantity Quantity that is reserved for a downstream channel replenishment order that is being prepared for shipment.
     *
     * @return $this
     */
